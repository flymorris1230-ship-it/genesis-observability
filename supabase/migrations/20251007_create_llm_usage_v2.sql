/**
 * Phase 3: LLM Usage Tracking Table (V2 - Renamed Column)
 * Stores LLM API usage data for observability
 *
 * FIX: Renamed "timestamp" to "event_time" to avoid PostgreSQL reserved keyword
 */
...
CREATE TABLE IF NOT EXISTS llm_usage (
  ...
  -- Event timestamp (renamed from "timestamp" to avoid reserved keyword)
