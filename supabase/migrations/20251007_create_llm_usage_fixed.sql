/**
 * Phase 3: LLM Usage Tracking Table (FIXED)
 * Stores LLM API usage data for observability
 *
 * FIX: Quote "timestamp" column in views to avoid reserved keyword conflict
 */
...
-- FIX: Quote "timestamp" to avoid reserved keyword conflict
